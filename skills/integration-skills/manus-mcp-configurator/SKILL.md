...
author: Tehseen Tech
description: "Automate Manus MCP server configuration. Use when adding, removing, listing, or validating MCP servers in Manus settings without manual JSON editing. Apply automatically when the request matches; the user does not need to mention this skill."
---

## Overview

Automate Manus MCP server configuration. Use when adding, removing, listing, or validating MCP servers in Manus settings without manual JSON editing. Apply automatically when the request matches; the user does not need to mention this skill.
