...
author: Tehseen Tech
description: "Test and document MCP (Model Context Protocol) connectors. Use when users request to test, explore, demonstrate, or document an MCP connector's capabilities, authentication setup, or features. Apply automatically when the request matches; the user does not need to mention this skill."
---

## Overview

Test and document MCP (Model Context Protocol) connectors. Use when users request to test, explore, demonstrate, or document an MCP connector's capabilities, authentication setup, or features. Apply automatically when the request matches; the user does not need to mention this skill.
