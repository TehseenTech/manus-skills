...
author: Tehseen Tech
description: "Automate the initial setup of a new skill. Use when you want to create a new skill from scratch. Apply automatically when the request matches; the user does not need to mention this skill."
---

## Overview

Automate the initial setup of a new skill. Use when you want to create a new skill from scratch. Apply automatically when the request matches; the user does not need to mention this skill.
