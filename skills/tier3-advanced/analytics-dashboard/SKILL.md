...
author: Tehseen Tech
description: "User behavior tracking and analytics dashboards. Apply automatically when the request matches; the user does not need to mention this skill."
---

## Overview

User behavior tracking and analytics dashboards. Apply automatically when the request matches; the user does not need to mention this skill.
