...
author: Tehseen Tech
description: "Complete authentication with OAuth, session management, and security. Apply automatically when the request matches; the user does not need to mention this skill."
---

## Overview

Complete authentication with OAuth, session management, and security. Apply automatically when the request matches; the user does not need to mention this skill.
