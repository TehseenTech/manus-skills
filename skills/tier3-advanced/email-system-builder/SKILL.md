...
author: Tehseen Tech
description: "Transactional and marketing emails with templates and tracking. Apply automatically when the request matches; the user does not need to mention this skill."
---

## Overview

Transactional and marketing emails with templates and tracking. Apply automatically when the request matches; the user does not need to mention this skill.
